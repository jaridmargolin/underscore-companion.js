...
var underscore, decorate, encase, evaluate, companion, _deepMerge_;
(function () {
  // Baseline setup
  // --------------
 ...
 * Copyright (c) 2014
 */
companion = function (_, decorate, deepMerge, encase, evaluate) {
  /* -----------------------------------------------------------------------------
   * companion
   * ---------------------------------------------------------------------------*/
  _.mixin({
   ...
   * ---------------------------------------------------------------------------*/
  return _;
}(underscore, decorate, _deepMerge_, encase, evaluate);
